import usaFlag from "../../Imagefor/icons/16.png";
import FotterLinkWrapper from "./FotterLinkWrapper/FotterLinkWrapper";
import './fotter.css'
import LinkWrapperScript  from './FotterLinkWrapper/LinkWrapper1/LinkWrapperScript'
function footer() {
  return (
    <>
      <footer className="footer-wrapper">
        <div className="container">
          ...
          <div className="my-apple-wrapper">
            More ways to shop: <a href="/applestore/">Find an Apple Store</a> or
            <a href="/retailer/">other retailer</a> near you. Or call
            1-800-MY-APPLE.
          </div>
        ...
        <LinkWrapperScript />
        <h1 className="text-center">Cloned by Amir Shkur</h1>
      </footer>
    </>
  );
}
